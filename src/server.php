...
switch(@$_GET["action"]) {
	...
	case "fetch":
		print reco_todo(
			"server",
			$_GET["action"],
			"забрать какой-то контент (список или элемент)"
		);
		break;
	// ----------------------------------------------------------------------
	case "index":
	...
	case "fill":
		print reco_todo(
			"server",
			$_GET["action"],
			"закрыть дырки в данных (посчитать метрики)"
		);
		break;
	// ----------------------------------------------------------------------
	case "calc":
	...
	case "make":
		print reco_todo(
			"server",
			$_GET["action"],
			"дать рекомендации по группам размещения"
		);
		break;
	// ----------------------------------------------------------------------
	case "ws":
